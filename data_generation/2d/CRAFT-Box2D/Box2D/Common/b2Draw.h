...
public:
    ...
    virtual void DrawTexturedPolygon(const b2Vec2* vertices, const b2Vec2* textureCoordinates, int32 vertexCount, const b2Color& color, uint32 glTexId, int matTexId) = 0;
    ...
    /// Draw a closed circle provided in CCW order by applying texture.
    virtual void DrawTexturedCircle(const b2Vec2& center, float32 radius, const b2Vec2& axis, const b2Color& color, uint32 glTexId, int matTexId) = 0;
